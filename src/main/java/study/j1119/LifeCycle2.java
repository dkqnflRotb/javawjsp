...
//	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		response.setContentType("text/html;charsat=utf-8");
		...
		// Get방식으로의 전송
		response.sendRedirect(request.getContextPath()+"/study/1119LifeCycle/test1Res2.jsp?title="+title+"&content="+content); //get방식은 앞에request.getContextPath() 를 넣어줘야지 찾아간다.
	}
	@Override
	public void destroy() {
