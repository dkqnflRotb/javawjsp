...
System.out.println("-----이곳은 doPost() 메소드 입니다.-----");
		...
		// Get방식으로의 전송
		response.sendRedirect(request.getContextPath()+"/study/1119LifeCycle/test1Res.jsp?title="+title+"&content="+content); //get방식은 앞에request.getContextPath() 를 넣어줘야지 찾아간다.
	}
