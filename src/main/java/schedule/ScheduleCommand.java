...
public class ScheduleCommand implements ScheduleInterface {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 오늘 날짜처리(저장)
		Calendar calToday = Calendar.getInstance(); //생성개념이아니고 메모리에 저장되있는걸 가져다쓴다.
		...
		// 오늘 날짜를 저장소에 담아서 넘겨준다.
			...
			System.out.println("preLastDay :" +preLastDay);
			System.out.println("nextStartWeek :" +nextStartWeek);
		...
		// 현재달의 '전월/다음월' 의 날짜 표시를 위한 변수를 저장소에 저장한다.
			...
			System.out.println("mid,ym : "+ mid+","+ym);
