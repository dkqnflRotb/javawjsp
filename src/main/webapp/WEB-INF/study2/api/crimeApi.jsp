...
<head>
  ...
  <script>
  	...
  	async function getCrimeData(){
  		...
  		// json객체 타입을 html에 출력시켜주기 위해 문자열형식으로 변경한다.
	...
	<div id="wrap">
		<div class="container">
  		<div>
  			...
  			<input type="button" value="DB출력" onclick="location.href='${ctp}/stCrimeList.st';" class="btn btn-info"/>
