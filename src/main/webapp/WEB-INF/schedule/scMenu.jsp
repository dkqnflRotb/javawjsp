	...
	<div id="wrap">
		<div class="container">
  		...
  		<div>
  			...
  			<input type="button" value="등록창닫기" onclick="scheduleInput_Hidden()" id="scheduleInputHidden" class="btn btn-danger"/>
	    ...
	    <table class="table table-hover text-center">
	      ...
	      <c:forEach var="vo" items="${vos}" varStatus="st">
	        <tr>
	          ...
	          <td>${vo.part}</td>
	          <td>
	          	<input type="button" value="수정" onclick="updateCheck('${vo.idx}','${vo.part}','${fn:replace(vo.content,newLine,'<br/>')}')" id="scheduleUpdateOpen${vo.idx}" class="btn btn-info btn-sm"/>
