...
insert into schedule values (default,'hkd1234','2023-01-05','여행','Spring설정공부');
...
select * from schedule where mid = 'hkd1234' and date_format(sDate,'%Y-%m')='2023-01' group by part order by sDate desc; -- 2023-01를 2023-1로쓰면 입력받을때 2023-01로받을수없다
select * from schedule where mid = 'hkd1234' and date_format(sDate,'%Y-%m')='2022-12' group by part order by sDate desc;
select *,count(*) from schedule where mid = 'hkd1234' and sDate='2022-12-25'  group by part order by idx desc;
