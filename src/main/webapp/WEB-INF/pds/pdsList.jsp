					...
					<tr>
						...
						<td>
  						...
  						<a href="${ctp}/pdsTotalDown.pds?idx=${vo.idx}" class="badge badge-secondary">전체다운</a><br/>
							<a href="javascript:pdsDelCheck('${vo.idx }','${vo.fSName}')" class="badge badge-danger badge-1">삭제1</a><br/> <!-- javascript:pdsDelCheck('${vo.idx }','${vo.fSName}')" 하나라도 타입이 문자면 숫자여도 문자타입으로 보내줘야함 안그럼 오류뜸 -->
							<a href="#" onclick="pdsDelCheckModal('${vo.idx}','${vo.fSName}')" data-toggle="modal" data-target="#myPwdModal" class="badge badge-danger ">모달창 삭제2</a> <!-- javascript:pdsDelCheck('${vo.idx }','${vo.fSName}')" 하나라도 타입이 문자면 숫자여도 문자타입으로 보내줘야함 안그럼 오류뜸 -->
						</td>
					</tr>
