...
create table member(
	...
	pwd varchar(100) not null,				 /* 비밀번호(SHA암호화 처리) pwd 길이짧으면 안들어감 */
	...
	point	int default 100, 			 	 	 	 /* 회원 누적포인트(가입시 기본 100포인트, 방문시 1회 10포인트, 1일 최애 50포인트) */
...
insert into member values (default,'admin','1234','관리맨','관리자',default,default,'010-3423-2704','청주시 사직대로 168','rlaehdaud42@naver.com','http://naver.com','프리랜서','게임/영화감상',default,'관리자입니다.',default,default,default,0,default,default,default,default);
