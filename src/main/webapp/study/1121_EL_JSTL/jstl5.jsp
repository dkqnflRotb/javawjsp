...
<body>
	...
	<div class="container">
		...
		%>
			...
			1-3. (천단위마다 콤마표시) 사용예: 1234.567 :  <fmt:formatNumber value="1234.567" pattern="#,##0.0"/></br/>
			...
			<p>절대경로: 그림1 <img src="${ctp}/images/K9.jpg" width="200px"/></p>
			<p>URL 문 : 그림2 <c:url var="img" value="../../images/람보르기니btn.jpg"/></br>
				              <img src="${img}" width="200px"/></p>
		</div>
	</div>
	<p><br/></p>
</body>
