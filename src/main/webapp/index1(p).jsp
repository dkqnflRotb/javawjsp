...
<body>
	<div class="wrap">
	<jsp:include page="include/pnav2.jsp"/>
		...
		<header class="w3-display-container w3-content w3-hide-small" style="max-width:1500px">
		  <img id="img1" class="w3-image" src="https://www.w3schools.com/w3images/london2.jpg" alt="London" width="1500" height="700">
		...
		<div class="swiper-container mt-5" style="height: 400px;">
	...
	<footer class="w3-center w3-margin-top" >
	  <div class="jumbotron text-center w3-opacity" style="margin:50px 0 0;padding:60px 0 30px 0; background-color:#000;color:white;">
		  <h5>Find Us On</h5>
